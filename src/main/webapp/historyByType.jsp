                ...
                <ul class="pagination justify-content-center">
                    <li class="page-item">
                        <c:if test="${requestScope.currentPage != 1}">
                            <a class="page-link" href="/log?currentPage=${requestScope.currentPage - 1}&type=${requestScope.type}">Previous</a>
                        </c:if>
                    </li>
                    ...
                    <c:otherwise>
                    <li class="page-item"><a href="/log?currentPage=${i}&type=${requestScope.type}"
                                             class="page-link">${i}</a>
                        </c:otherwise>
                        </c:choose>
                        </c:forEach>
                    ...
                    <li class="page-item">
                        <a href="/log?currentPage=${currentPage + 1}&type=${requestScope.type}" class="page-link">Next</a>
                    </li>
                    </c:if>
                    </li>
                </ul>
